SETUP
This is a car washing application that washes cars. The two features are washes and add-ons. The system was built as a prototype and works well, but the complexity is already adding up. 
Additionally, many more washes and add-ons are expected to be brought on over time.
